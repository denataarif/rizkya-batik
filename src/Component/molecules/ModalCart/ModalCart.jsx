  ...
  return (
    <>
      <Modal isOpen={isOpen} onClose={isClose} >
        <div className='flex w-full justify-end items-center' onClick={isClose}>
        ...
        <div className='flex gap-5 mt-12'>
          <div className='border border-black p-10 flex justify-between gap-x-5'>
            ...
            <div className='flex flex-col gap-y-6'>
              <div className='flex flex-col'>
                <Typhograph children='Inner Dress mala Batik Tulis' className='font-bold text-2xl text-[#694705]'/>
                <Typhograph children='Rp 700,000' className='text-[#694705] text-2xl'/>
              </div>
              <div className='flex flex-col '>
                ...
                <div className='flex justify-around items-center w-full'>
                  <div className='border border-isActive size-8 flex justify-center items-center'>
                    <Typhograph children='-' className='text-isActive font-bold text-2xl'/>
                  </div>
          ...
          <div className='border border-black p-8 flex flex-col gap-8'>
            <Typhograph children='Ringkasan Pembelanjaan' className='font-bold text-3xl'/>
