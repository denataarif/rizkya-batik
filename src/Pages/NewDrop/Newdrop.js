...
const Newdrop = () => {
  ...
  const product = [
    {id:1, images:`${assets.Aksamala1}`, Caption:"Aksamala Dress Mala Batik tulis", Harga:"2.100.000"},
    {id:2, images:`${assets.Aksamala2}`, Caption:"Aksamala Dress Aksa Batik tulis", Harga:"2.100.000"},
    {id:3, images:`${assets.Aksamala3}`, Caption:"Aksamala Dress Aksa Batik tulis", Harga:"2.100.000"},
    {id:4, images:`${assets.Aksamala4}`, Caption:"Aksamala Dress Mala Batik tulis", Harga:"2.100.000"},
    {id:5, images:`${assets.Aksamala1}`, Caption:"Aksamala Dress Mala Batik tulis", Harga:"2.100.000"},
    {id:6, images:`${assets.Aksamala1}`, Caption:"Aksamala Dress Mala Batik tulis", Harga:"2.100.000"},
    {id:7, images:`${assets.Aksamala1}`, Caption:"Aksamala Dress Mala Batik tulis", Harga:"2.100.000"},
    {id:8, images:`${assets.Aksamala1}`, Caption:"Aksamala Dress Mala Batik tulis", Harga:"2.100.000"},
    {id:9, images:`${assets.Aksamala1}`, Caption:"Aksamala Dress Mala Batik tulis", Harga:"2.100.000"}
  ]
                ...
                <div className='grid grid-cols-3 gap-8 '>
                  {
                    product.map((items, index) => {
                      return(
                        <Card key={index} Image={items.images} Caption={items.Caption} Harga={items.Harga}/>
                      )
                    })
                  }
                </div>
